"""
Django settings for escape_40684 project.
...
ROOT_URLCONF = 'escape_40684.urls'
...
WSGI_APPLICATION = 'escape_40684.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "escape_40684 API",
    "DESCRIPTION": "API documentation for escape_40684 App",
    "VERSION": "v1",
}
